...
<head>
    ...
    <title>Adicionar Cliente - Meu Agrônomo</title>
...
<body class="dashboard-body">
            ...
            <ul>
                ...
                <li class="menu-drop {{ Request::routeIs('clientes.*') ? 'open' : '' }}">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="{{ route('clientes.index') }}" class="{{ Request::routeIs('clientes.index') ? 'active' : '' }}">Lista de clientes</a></li>
    ...
    <main class="conteudo-principal">
        ...
        <section class="form-cliente">
            <h1>Adicionar Novo Cliente</h1> {{-- Título secundário dentro da seção --}}
